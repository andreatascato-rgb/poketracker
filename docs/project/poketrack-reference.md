...
|----------|-------------|----------------------|
| **Layout shell** | Top Bar 48px + Sidebar 280px (48px collassata) + area contenuto flex 1; scroll solo nell'area contenuto | `src/routes/+layout.svelte` |
...
- **Sidebar**: voci raggruppate, icone, gruppi espandibili, stile hover/active (quando ripristiniamo/estendiamo la nav).
